<%-- 
    Document   : HomeWage
    Created on : Dec 4, 2024, 1:33:07 PM
    Author     : hathu
--%>
    ...
    <div class="container">
        <div class="navigation">
            <ul>
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/employeenotificationServlet">
                        <span class="icon">
            ...
            <div class="details">
                ...
                <div class="recentCustomers">
                    ...
                    <table>
                        <tr>
                            <td width="60px">
                                <div class="imgBx"><img src="https://upload.wikimedia.org/wikipedia/vi/a/a5/Mixigaming-Logo.jpg" alt=""></div>
                            </td>
                            <td>
